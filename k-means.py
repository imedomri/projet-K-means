...
label2 = tk.Label(root, text='Donner K:')
...
browseButtonExcel = tk.Button(text=" Importer Fichier Excel ", command=getExcel,
...
def getKMeans():
    ...
    ax1.scatter(df['x'], df['y'], c=kmeans.labels_.astype(
...
processButton = tk.Button(text='k-Means ', command=getKMeans,
